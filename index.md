...
* Conduct a user study to evaluate produced explanations based on their utility. The course has a dedicated session for preparing an interface for a user study and another session for conducting it with class peers. A successful final project presentation will show how well explanations accomplish the explanatory function in your evaluation framework.
